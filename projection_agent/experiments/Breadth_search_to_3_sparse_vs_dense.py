...
agents = [
    ...
    Agent(horizon=1,scoring_function=bw.F1score,sparse=True),
    Agent(horizon=2,scoring_function=bw.F1score,sparse=True),
    Agent(horizon=3,scoring_function=bw.F1score,sparse=True),
    # Agent(horizon=4,scoring_function=bw.F1score,sparse=True),
    Agent(horizon=1,scoring_function=bw.silhouette_hole_score,sparse=True),
    Agent(horizon=2,scoring_function=bw.silhouette_hole_score,sparse=True),
    Agent(horizon=3,scoring_function=bw.silhouette_hole_score,sparse=True),
