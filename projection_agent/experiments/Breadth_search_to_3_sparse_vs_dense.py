...
agents = [
    ...
    BFS_Agent(horizon=1,scoring_function=bw.F1score,sparse=True),
    BFS_Agent(horizon=2,scoring_function=bw.F1score,sparse=True),
    BFS_Agent(horizon=3,scoring_function=bw.F1score,sparse=True),
    # Agent(horizon=4,scoring_function=bw.F1score,sparse=True),
    BFS_Agent(horizon=1,scoring_function=bw.silhouette_hole_score,sparse=True),
    BFS_Agent(horizon=2,scoring_function=bw.silhouette_hole_score,sparse=True),
    BFS_Agent(horizon=3,scoring_function=bw.silhouette_hole_score,sparse=True),
...
worlds_silhouettes = {'int_struct_'+str(i) : bw.Blockworld(silhouette=s,block_library=bl.bl_silhouette2_default) for i,s in silhouettes}
worlds_small = {
