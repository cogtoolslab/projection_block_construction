...
"""⚠️ Takes a lot of RAM: >30GB!"""

agents = [
    # Agent(horizon=1,scoring_function=bw.random_scoring),
    BFS_Agent(horizon=5,scoring_function=bw.F1score),
...
results = experiment_runner.run_experiment(worlds,agents,1,10,verbose=False,parallelized=False,save='breadth_search_to_5')
