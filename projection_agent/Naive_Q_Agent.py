...
class Naive_Q_Agent(BFS_Agent):
    ...
    def __str__(self):
        ...
        return 'type: '+self.__class__.__name__+' heuristic: '+self.heuristic.__name__+' max_episodes: '+str(self.max_steps)+' max_streaks: '+str(self.max_streaks)+' explore_rate: '+str(self.explore_rate)+' learning_rate: '+str(self.learning_rate)+' discount_factor: '+str(self.discount_factor)
