if __name__=="__main__": #required for multiprocessing
    ...
    agents = [
        #default
        BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3),
        CPA.Construction_Paper_Agent(decomposition_function=CPA.random_1_4_h,lower_agent=BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3)),
        #random_2_4_h
        # BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3),
        CPA.Construction_Paper_Agent(decomposition_function=CPA.random_2_4_h,lower_agent=BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3)),
        # CPA.Construction_Paper_Agent(decomposition_function=CPA.random_2_4_v,lower_agent=BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3)),
        #fixed_2_h
        # BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3),
        CPA.Construction_Paper_Agent(decomposition_function=CPA.fixed_2_h,lower_agent=BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3)),
        CPA.Construction_Paper_Agent(decomposition_function=CPA.fixed_4_h,lower_agent=BFS_Lookahead_Agent(only_improving_actions = True,horizon = 3)),
        ]
