if __name__=="__main__": #required for multiprocessing
    ...
    for l in [1] for cw in np.linspace(0.,.01,16)
    ]+ [
        Simulated_Lookahead_Subgoal_Planning_Agent(
        sequence_length=l,
        include_subsequences=False,
    ...
    experiment_runner.run_experiment(df,agents,1,20,parallelized=fraction_of_cpus,save="simulated lookaheads TESTING",maxtasksperprocess = 1,chunk_experiments_size=10)
