...
if __name__ == "__main__":  # required for multiprocessing
    ...
    lower_agent = BFS_Agent(random_seed=42)
    ...
    scoping_agents = [
        Subgoal_Planning_Agent(
            ...
            label="Incremental Scoping lambda={}".format(cw),
        )
        for cw in lambdas
    ]
    ...
    lookahead2_agents = [
        Subgoal_Planning_Agent(
            ...
            step_size=1,
            max_number_of_sequences=8192,
            label="Lookahead Scoping lambda={}".format(cw),
        )
        for cw in lambdas
    ]
    ...
    results_sg = experiment_runner.run_experiment(
        ...
        save="RLDM_scoping_BFS_experiment",
