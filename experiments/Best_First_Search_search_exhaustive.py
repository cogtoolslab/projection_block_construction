if __name__=="__main__": #required for multiprocessing
    ...
    results = experiment_runner.run_experiment(worlds,agents,1,1,verbose=False,parallelized=fraction_of_cpus,save='Best_First_Search_search_exhaustive',maxtasksperprocess = 1)
