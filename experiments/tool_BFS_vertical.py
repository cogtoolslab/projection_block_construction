if __name__=="__main__": #required for multiprocessing
    ...
    results = experiment_runner.run_experiment(worlds,agents,100,20,verbose=False,parallelized=fraction_of_cpus,save='tools_BFS_vertical',maxtasksperprocess=100)
