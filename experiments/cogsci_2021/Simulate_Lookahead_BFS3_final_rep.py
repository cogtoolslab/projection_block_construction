if __name__=="__main__": #required for multiprocessing
    ...
    agents =  [
        ...
        for l in [1] for cw in np.linspace(0.,.008,100)
        ]+ [
            Simulated_Lookahead_Subgoal_Planning_Agent(
            sequence_length=l,
            include_subsequences=False,
    ...
    results = experiment_runner.run_experiment(df,agents,32,20,parallelized=fraction_of_cpus,save="simulated lookaheads BFS3/final",maxtasksperprocess = 256,chunk_experiments_size=1024)
