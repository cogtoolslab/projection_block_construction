...
def get_BFS_dfs(worlds, save = "simulated_subgoal_agent_BFS"):
    ...
    sga = Subgoal_Planning_Agent(lower_agent=BFS_Agent(),
    decomposer=decomposer)
    ns_agent = Simulated_Subgoal_Agent(decomposer=decomposer, label="BFS No Subgoals", step_size=-1)

    print("Running the subgoal generator")
    results = experiments.subgoal_generator_runner.run_experiment(worlds, [sga, 1, 1,], parallelized = FRACTION_OF_CPUS, save = False, maxtasksperprocess = 1)
